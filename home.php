...
<html lang="en">
  <head>
    ...
    <title>Velect - Online Voting System</title>
	<style type='text/css'>
		.card{
			float:left;
			margin: 24px;
  ...
  <body style="background-color: grey;">
	...
	<div class="jumbotron">
	  ...
	  <p class="lead">Velect is a web-development based voting system that will help you to manage your election effortlessly and reliably.</p>
	  <hr class="my-4">
	  <p>Elections are the essential part of every democratic society, entity, institution, organization, etc. Hence it is very important to hold up as many elections as possible. Unfortunately, elections come with big administrative efforts and costs. In order to circumvent the drawbacks of conventional “physical elections”, we  suggest the use of cheaper online voting system: <b>Velect</b>.
	  </p>
	</div>
